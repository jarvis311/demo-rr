...
ServiceCenterData.belongsTo(ServiceCenterBrand,{
    foreignKey:"brand_id",
    as:"BrandDetails"
})

ServiceCenterBrand.hasMany(ServiceCenterData,{
    foreignKey:"brand_id",
    as:"BrandDetails"
})

ServiceCenterData.belongsTo(ServiceCenterCity,{
    foreignKey:"city_id",
    as:"cityDetails"
})

ServiceCenterCity.hasMany(ServiceCenterData,{
    foreignKey:"city_id",
    as:"cityDetails"
})
