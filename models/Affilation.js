import {
  ...
  AffilationData.belongsTo(Affilation, {
    foreignKey: 'affiliate_id', // Foreign key in the Affilation model
    targetKey: 'id', // Target key in the AffiliationServices model
    as: 'get_affilation', // This sets the alias for the association
  });


Affilation.hasMany(AffilationData,{
    foreignKey: 'affiliate_id',
